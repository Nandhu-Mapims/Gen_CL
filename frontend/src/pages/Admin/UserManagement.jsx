                    ...
                    <td className="px-4 lg:px-6 py-3 lg:py-4">
                      <span
                        className={`px-2 lg:px-3 py-1 rounded-full text-xs font-medium ${
                          user.role === 'SUPER_ADMIN' ? 'bg-maroon-100 text-maroon-700' : user.role === 'DEPT_ADMIN' ? 'bg-amber-100 text-amber-700' : user.role === 'SUPERVISOR' ? 'bg-maroon-100 text-maroon-700' : user.role === 'QA' ? 'bg-teal-100 text-teal-700' : 'bg-maroon-100 text-maroon-700'
                        }`}
                      >
              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <span
                  className={`px-2 py-1 rounded-full text-xs font-medium ${
                    user.role === 'SUPER_ADMIN' ? 'bg-maroon-100 text-maroon-700' : 'bg-maroon-100 text-maroon-700'
                  }`}
                >
