...
function SidebarMenuItem({ to, icon, label, isActive, accentColor = 'maroon' }) {
  return (
    <Link
      to={to}
    ...
    <div className="min-h-screen bg-gradient-to-br from-maroon-50 via-maroon-50 to-pink-50">
      ...
      <div className="flex pt-24">
        ...
        <>
          ...
          <aside className={`fixed left-0 top-24 bottom-0 w-72 bg-white/95 backdrop-blur-md shadow-xl border-r border-maroon-200/50 z-40 transform transition-transform duration-300 ease-in-out ${
